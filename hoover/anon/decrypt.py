...
ANON_DB_FOLDER_PATH = '/cmb/data/anonymization'
...
def retrieve_key_from_anon(hash_range_str):
...
def deanonymize(anonymized_id):
    ...
    key = retrieve_key_from_anon(hash_range_str=hash_range_str)
...
if __name__ == '__main__':
    ...
    df['deanonymized_id'] = df['anonymized_id'].apply(deanonymize)
